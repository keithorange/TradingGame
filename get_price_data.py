...
assets = [
    ...
    {"ticker": "GC=F", "category": "commodity", "human_name": "Gold Futures"},
    {"ticker": "SI=F", "category": "commodity", "human_name": "Silver Futures"},
    {"ticker": "HG=F", "category": "commodity", "human_name": "Copper Futures"},
    {"ticker": "PL=F", "category": "commodity", "human_name": "Platinum Futures"},
    {"ticker": "PA=F", "category": "commodity", "human_name": "Palladium Futures"},
    {"ticker": "CL=F", "category": "commodity", "human_name": "Crude Oil Futures"},
    {"ticker": "NG=F", "category": "commodity", "human_name": "Natural Gas Futures"},
    {"ticker": "ZC=F", "category": "commodity", "human_name": "Corn Futures"},
    {"ticker": "ZS=F", "category": "commodity", "human_name": "Soybean Futures"},
    {"ticker": "ZW=F", "category": "commodity", "human_name": "Wheat Futures"},
    {"ticker": "CC=F", "category": "commodity", "human_name": "Cocoa Futures"},
    {"ticker": "SB=F", "category": "commodity", "human_name": "Sugar Futures"},
    {"ticker": "KC=F", "category": "commodity", "human_name": "Coffee Futures"},
    {"ticker": "CT=F", "category": "commodity", "human_name": "Cotton Futures"},
    {"ticker": "OJ=F", "category": "commodity", "human_name": "Orange Juice Futures"}
]
